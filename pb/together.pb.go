...
type TileUpdate struct {
	...
	Coordinates *Vector `protobuf:"bytes,1,opt,name=Coordinates,json=coordinates,proto3" json:"Coordinates,omitempty"`
	TileData    []byte  `protobuf:"bytes,2,opt,name=TileData,json=tileData,proto3" json:"TileData,omitempty"`
}
...
func (x *TileUpdate) GetCoordinates() *Vector {
	if x != nil {
		return x.Coordinates
	}
	return nil
...
var file_together_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x22, 0x56, 0x0a, 0x0a, 0x54,
	0x69, 0x6c, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x2c, 0x0a, 0x0b, 0x43, 0x6f, 0x6f,
	...
	0x64, 0x69, 0x6e, 0x61, 0x74, 0x65, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x54, 0x69, 0x6c, 0x65, 0x44,
	0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x74, 0x69, 0x6c, 0x65, 0x44,
	0x61, 0x74, 0x61, 0x32, 0xb9, 0x01, 0x0a, 0x0b, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76,
	...
	0x63, 0x6b, 0x28, 0x01, 0x12, 0x22, 0x0a, 0x09, 0x4c, 0x6f, 0x61, 0x64, 0x43, 0x68, 0x75, 0x6e,
	0x6b, 0x12, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x1a, 0x09, 0x2e,
	0x70, 0x62, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x25, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x54, 0x69, 0x6c, 0x65, 0x12, 0x0e, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x69, 0x6c, 0x65,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x1a, 0x07, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x63, 0x6b, 0x42,
...
var file_together_proto_depIdxs = []int32{
	...
	3,  // 7: pb.TileUpdate.Coordinates:type_name -> pb.Vector
	2,  // 8: pb.GameService.Connect:input_type -> pb.ConnectRequest
	5,  // 9: pb.GameService.SendPlayerUpdates:input_type -> pb.PlayerEvent
	3,  // 10: pb.GameService.LoadChunk:input_type -> pb.Vector
	8,  // 11: pb.GameService.UpdateTile:input_type -> pb.TileUpdate
	6,  // 12: pb.GameService.Connect:output_type -> pb.GameState
	1,  // 13: pb.GameService.SendPlayerUpdates:output_type -> pb.Ack
	7,  // 14: pb.GameService.LoadChunk:output_type -> pb.Chunk
	1,  // 15: pb.GameService.UpdateTile:output_type -> pb.Ack
